...
# Unit tests for SwaggerClient::RepositoryAddRemoveContent
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RepositoryAddRemoveContent' do
  before do
    # run before each test
    @instance = SwaggerClient::RepositoryAddRemoveContent.new
  end
  ...
  describe 'test an instance of RepositoryAddRemoveContent' do
    it 'should create an instance of RepositoryAddRemoveContent' do
      expect(@instance).to be_instance_of(SwaggerClient::RepositoryAddRemoveContent)
    end
  end
