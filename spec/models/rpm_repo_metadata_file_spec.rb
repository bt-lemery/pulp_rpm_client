...
# Unit tests for SwaggerClient::RpmRepoMetadataFile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RpmRepoMetadataFile' do
  before do
    # run before each test
    @instance = SwaggerClient::RpmRepoMetadataFile.new
  end
  ...
  describe 'test an instance of RpmRepoMetadataFile' do
    it 'should create an instance of RpmRepoMetadataFile' do
      expect(@instance).to be_instance_of(SwaggerClient::RpmRepoMetadataFile)
    end
  end
