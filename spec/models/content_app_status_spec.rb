...
# Unit tests for PulpRpmClient::ContentAppStatus
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ContentAppStatus' do
  before do
    # run before each test
    @instance = PulpRpmClient::ContentAppStatus.new
  end
  ...
  describe 'test an instance of ContentAppStatus' do
    it 'should create an instance of ContentAppStatus' do
      expect(@instance).to be_instance_of(PulpRpmClient::ContentAppStatus)
    end
  end
