...
# Unit tests for SwaggerClient::RepositoryVersion
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RepositoryVersion' do
  before do
    # run before each test
    @instance = SwaggerClient::RepositoryVersion.new
  end
  ...
  describe 'test an instance of RepositoryVersion' do
    it 'should create an instance of RepositoryVersion' do
      expect(@instance).to be_instance_of(SwaggerClient::RepositoryVersion)
    end
  end
