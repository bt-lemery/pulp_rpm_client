...
# Unit tests for PulpRpmClient::FileFilePublication
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FileFilePublication' do
  before do
    # run before each test
    @instance = PulpRpmClient::FileFilePublication.new
  end
  ...
  describe 'test an instance of FileFilePublication' do
    it 'should create an instance of FileFilePublication' do
      expect(@instance).to be_instance_of(PulpRpmClient::FileFilePublication)
    end
  end
