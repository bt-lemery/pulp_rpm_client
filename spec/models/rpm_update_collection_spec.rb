...
# Unit tests for SwaggerClient::RpmUpdateCollection
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RpmUpdateCollection' do
  before do
    # run before each test
    @instance = SwaggerClient::RpmUpdateCollection.new
  end
  ...
  describe 'test an instance of RpmUpdateCollection' do
    it 'should create an instance of RpmUpdateCollection' do
      expect(@instance).to be_instance_of(SwaggerClient::RpmUpdateCollection)
    end
  end
