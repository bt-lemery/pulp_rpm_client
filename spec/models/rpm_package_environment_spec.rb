...
# Unit tests for SwaggerClient::RpmPackageEnvironment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RpmPackageEnvironment' do
  before do
    # run before each test
    @instance = SwaggerClient::RpmPackageEnvironment.new
  end
  ...
  describe 'test an instance of RpmPackageEnvironment' do
    it 'should create an instance of RpmPackageEnvironment' do
      expect(@instance).to be_instance_of(SwaggerClient::RpmPackageEnvironment)
    end
  end
