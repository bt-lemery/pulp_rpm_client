...
# Unit tests for SwaggerClient::RpmPackageLangpacks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RpmPackageLangpacks' do
  before do
    # run before each test
    @instance = SwaggerClient::RpmPackageLangpacks.new
  end
  ...
  describe 'test an instance of RpmPackageLangpacks' do
    it 'should create an instance of RpmPackageLangpacks' do
      expect(@instance).to be_instance_of(SwaggerClient::RpmPackageLangpacks)
    end
  end
