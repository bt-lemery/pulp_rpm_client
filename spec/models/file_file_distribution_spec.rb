...
# Unit tests for SwaggerClient::FileFileDistribution
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FileFileDistribution' do
  before do
    # run before each test
    @instance = SwaggerClient::FileFileDistribution.new
  end
  ...
  describe 'test an instance of FileFileDistribution' do
    it 'should create an instance of FileFileDistribution' do
      expect(@instance).to be_instance_of(SwaggerClient::FileFileDistribution)
    end
  end
