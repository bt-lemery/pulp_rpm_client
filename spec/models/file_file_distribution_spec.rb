...
# Unit tests for PulpRpmClient::FileFileDistribution
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FileFileDistribution' do
  before do
    # run before each test
    @instance = PulpRpmClient::FileFileDistribution.new
  end
  ...
  describe 'test an instance of FileFileDistribution' do
    it 'should create an instance of FileFileDistribution' do
      expect(@instance).to be_instance_of(PulpRpmClient::FileFileDistribution)
    end
  end
