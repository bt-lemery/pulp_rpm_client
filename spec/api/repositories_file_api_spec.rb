...
# Unit tests for SwaggerClient::RepositoriesFileApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RepositoriesFileApi' do
  before do
    # run before each test
    @instance = SwaggerClient::RepositoriesFileApi.new
  end
  ...
  describe 'test an instance of RepositoriesFileApi' do
    it 'should create an instance of RepositoriesFileApi' do
      expect(@instance).to be_instance_of(SwaggerClient::RepositoriesFileApi)
    end
  end
