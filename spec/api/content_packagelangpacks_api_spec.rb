...
# Unit tests for SwaggerClient::ContentPackagelangpacksApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ContentPackagelangpacksApi' do
  before do
    # run before each test
    @instance = SwaggerClient::ContentPackagelangpacksApi.new
  end
  ...
  describe 'test an instance of ContentPackagelangpacksApi' do
    it 'should create an instance of ContentPackagelangpacksApi' do
      expect(@instance).to be_instance_of(SwaggerClient::ContentPackagelangpacksApi)
    end
  end
