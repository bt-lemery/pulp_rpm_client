...
# Unit tests for PulpRpmClient::FileExportersFileApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FileExportersFileApi' do
  before do
    # run before each test
    @instance = PulpRpmClient::FileExportersFileApi.new
  end
  ...
  describe 'test an instance of FileExportersFileApi' do
    it 'should create an instance of FileExportersFileApi' do
      expect(@instance).to be_instance_of(PulpRpmClient::FileExportersFileApi)
    end
  end
