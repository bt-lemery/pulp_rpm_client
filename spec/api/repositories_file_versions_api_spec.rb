...
# Unit tests for PulpRpmClient::RepositoriesFileVersionsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RepositoriesFileVersionsApi' do
  before do
    # run before each test
    @instance = PulpRpmClient::RepositoriesFileVersionsApi.new
  end
  ...
  describe 'test an instance of RepositoriesFileVersionsApi' do
    it 'should create an instance of RepositoriesFileVersionsApi' do
      expect(@instance).to be_instance_of(PulpRpmClient::RepositoriesFileVersionsApi)
    end
  end
