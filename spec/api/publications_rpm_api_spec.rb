...
# Unit tests for SwaggerClient::PublicationsRpmApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PublicationsRpmApi' do
  before do
    # run before each test
    @instance = SwaggerClient::PublicationsRpmApi.new
  end
  ...
  describe 'test an instance of PublicationsRpmApi' do
    it 'should create an instance of PublicationsRpmApi' do
      expect(@instance).to be_instance_of(SwaggerClient::PublicationsRpmApi)
    end
  end
