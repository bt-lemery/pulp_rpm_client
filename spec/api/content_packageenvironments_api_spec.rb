...
# Unit tests for SwaggerClient::ContentPackageenvironmentsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ContentPackageenvironmentsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::ContentPackageenvironmentsApi.new
  end
  ...
  describe 'test an instance of ContentPackageenvironmentsApi' do
    it 'should create an instance of ContentPackageenvironmentsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::ContentPackageenvironmentsApi)
    end
  end
