...
# Unit tests for PulpRpmClient::DistributionsFileApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DistributionsFileApi' do
  before do
    # run before each test
    @instance = PulpRpmClient::DistributionsFileApi.new
  end
  ...
  describe 'test an instance of DistributionsFileApi' do
    it 'should create an instance of DistributionsFileApi' do
      expect(@instance).to be_instance_of(PulpRpmClient::DistributionsFileApi)
    end
  end
