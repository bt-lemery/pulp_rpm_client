...
# Unit tests for SwaggerClient::RepositoriesRpmApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RepositoriesRpmApi' do
  before do
    # run before each test
    @instance = SwaggerClient::RepositoriesRpmApi.new
  end
  ...
  describe 'test an instance of RepositoriesRpmApi' do
    it 'should create an instance of RepositoriesRpmApi' do
      expect(@instance).to be_instance_of(SwaggerClient::RepositoriesRpmApi)
    end
  end
