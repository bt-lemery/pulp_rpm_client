...
# Unit tests for SwaggerClient::ContentModulemdsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ContentModulemdsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::ContentModulemdsApi.new
  end
  ...
  describe 'test an instance of ContentModulemdsApi' do
    it 'should create an instance of ContentModulemdsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::ContentModulemdsApi)
    end
  end
