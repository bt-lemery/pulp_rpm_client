...
module PulpRpmClient
  class ContentPackagelangpacksApi
    ...
    def delete_with_http_info(package_langpacks_href, opts = {})
      ...
      # resource path
      local_var_path = '{package_langpacks_href}'.sub('{' + 'package_langpacks_href' + '}', package_langpacks_href.to_s)
    ...
    # @option opts [String] :fields A list of fields to include in the response.
    # @option opts [String] :exclude_fields A list of fields to exclude from the response.
    # @return [Array<(RpmPackageLangpacks, Fixnum, Hash)>] RpmPackageLangpacks data, response status code and response headers
    def read_with_http_info(package_langpacks_href, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'RpmPackageLangpacks')
      if @api_client.config.debugging
