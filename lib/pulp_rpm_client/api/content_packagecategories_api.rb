...
module SwaggerClient
  class ContentPackagecategoriesApi
    ...
    def delete_with_http_info(package_category_href, opts = {})
      ...
      # resource path
      local_var_path = '{package_category_href}'.sub('{' + 'package_category_href' + '}', package_category_href.to_s)
    ...
    # @option opts [String] :fields A list of fields to include in the response.
    # @option opts [String] :exclude_fields A list of fields to exclude from the response.
    # @return [Array<(RpmPackageCategory, Fixnum, Hash)>] RpmPackageCategory data, response status code and response headers
    def read_with_http_info(package_category_href, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'RpmPackageCategory')
      if @api_client.config.debugging
