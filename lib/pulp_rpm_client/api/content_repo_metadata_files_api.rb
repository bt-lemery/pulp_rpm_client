...
module PulpRpmClient
  class ContentRepoMetadataFilesApi
    ...
    def delete_with_http_info(repo_metadata_file_href, opts = {})
      ...
      # resource path
      local_var_path = '{repo_metadata_file_href}'.sub('{' + 'repo_metadata_file_href' + '}', repo_metadata_file_href.to_s)
    ...
    # @option opts [String] :fields A list of fields to include in the response.
    # @option opts [String] :exclude_fields A list of fields to exclude from the response.
    # @return [Array<(RpmRepoMetadataFile, Fixnum, Hash)>] RpmRepoMetadataFile data, response status code and response headers
    def read_with_http_info(repo_metadata_file_href, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'RpmRepoMetadataFile')
      if @api_client.config.debugging
